...
export const INFO = [
  {
    ...
    h1: "About",
    sections: [
      ["What this is", "The YouTube Thumbnail Downloader is a free web tool that downloads the thumbnail image of any public YouTube video. You paste a link, choose a size, and the original image file saves directly to your device. No account, no extension, no watermark."],
      ["Why it is free", "The tool is deliberately simple and runs entirely in your browser. It fetches publicly available images from YouTube's own image CDN (i.ytimg.com), so there are no servers to operate and no reason to charge. Keeping it free is the whole point."],
      ["Privacy", "Links are processed locally in your browser. Nothing you paste is stored, logged, or shared with any server. Your video history never leaves your device."],
      ["What the tool is not", "This is not an affiliated or sponsored YouTube product, and it is not a video downloader. It only retrieves the thumbnail image of a video — the same public image you see in search results and embeds."],
      ["Why we built it", "Screenshots lose quality, right-clicking gives a compressed preview, and building image URLs by hand is tedious. We wanted a one-step way to get the original thumbnail file, so we built one and kept it open for everyone."],
    ],
  },
  {
    slug: "contact",
  ...
  },
  {
    ...
    h1: "Privacy Policy",
    sections: [
      ["Summary", "The tool is designed to collect no personal data. Everything you paste is processed in your browser and is never sent to our servers. This page explains that in detail."],
      ["Information we do not collect", "We do not collect names, email addresses, video links, search history, download history, or any other personal information. There is no account system, no profile, and no tracking of individual users."],
      ["How the tool works", "When you paste a YouTube link, the tool extracts the video ID in your browser and builds the public thumbnail URL (https://i.ytimg.com/vi/VIDEO_ID/SIZE.jpg). Your browser then loads that image directly from YouTube's CDN. The link itself is never transmitted to us."],
  ...
  },
  {
    ...
    h1: "Terms of Use",
    sections: [
      ["Acceptance", "By using this tool you agree to these Terms of Use. If you do not agree, do not use the site."],
      ["The service", "The YouTube Thumbnail Downloader is provided free of charge as an experimental utility. It retrieves thumbnail images of public YouTube videos directly from YouTube's public image servers."],
      ["Acceptable use", "Use the tool for lawful purposes: personal reference, study, design research, archiving your own uploads, or other legitimate uses. Do not use it to circumvent access controls, harvest data at scale to harm others, or facilitate infringement."],
      ["Copyright and ownership", "Thumbnails are the property of their respective uploaders and content owners. The tool does not grant you any rights to the images. Do not reuse another creator's thumbnail on your own video or in commercial material without permission."],
      ["No affiliation", "This site is an independent project. It is not affiliated with, endorsed by, or sponsored by YouTube or Google LLC. YouTube is a trademark of Google LLC."],
      ["Availability", "The tool depends on YouTube's public image servers and on the availability of the site's hosting. We may modify, suspend, or discontinue any part of the service at any time without notice."],
  ...
  },
  {
    ...
    h1: "Disclaimer",
    sections: [
      ["No affiliation", "YouTube is a trademark of Google LLC. This is an independent tool and is not affiliated with, endorsed by, or sponsored by YouTube, Google, or any other brand mentioned on this site."],
      ["Image ownership", "Downloaded thumbnails belong to their respective uploaders and copyright holders. The tool merely retrieves publicly available image files; it does not transfer ownership. You are solely responsible for how you use the images."],
      ["Fair use", "Personal, educational, and research use of thumbnails is generally accepted practice. Commercial reuse, republication, or redistribution of another creator's thumbnail may require permission from the copyright holder. When in doubt, ask the owner."],
